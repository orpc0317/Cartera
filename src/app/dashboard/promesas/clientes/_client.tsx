                  ...
                  return (
                    <TableHead key="proyecto">
                      <ColumnFilter
                        ...
                        active={new Set([...(colFilters['proyecto'] ?? new Set())].map((k) => proyectoMap.get(k) ?? `#${k}`))}
                        onChange={(labels) => {
                        ...
                        case 'proyecto':
                          return (
                            <TableCell key="proyecto" className="text-muted-foreground">
                              {proyectoMap.get(`${cliente.empresa}-${cliente.proyecto}`) ?? `#${cliente.proyecto}`}
                            </TableCell>
                          )
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div className="flex-1 grid grid-cols-2 gap-2">
                    ...
                    <div className="col-span-2 grid gap-1.5">
                      <span className="font-semibold tracking-wider leading-none text-muted-foreground" style={{ fontSize: 'var(--ui-viewfield-label)' }}>Telefono</span>
                      <div className="flex items-center rounded-none bg-transparent border-0 border-b border-primary/50 px-2" style={{ height: 'var(--ui-field-height)' }}>
                    ...
                    <div className="col-span-2 grid gap-1.5">
                      <span className="font-semibold tracking-wider leading-none text-muted-foreground" style={{ fontSize: 'var(--ui-viewfield-label)' }}>Telefono 2</span>
                      <div className="flex items-center rounded-none bg-transparent border-0 border-b border-primary/50 px-2" style={{ height: 'var(--ui-field-height)' }}>
